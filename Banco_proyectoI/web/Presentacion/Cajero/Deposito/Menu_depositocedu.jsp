...
<html>
    ...
    <body>
         ...
         <%if(cuentas==null) {%>
         <form class="form_inicio" action="/Banco_proyectoI/Presentacion/Cajero/Deposito/showcuentas" method="POST">
             <h2>Deposito</h2>    
             <p>Cedula:</p><input class="<%=this.Invalida("txtCedula", errores) %>"  type="text"  name="txtCedula" placeholder="<%=this.placeholder("txtCedula", errores, "Cedula cliente") %>"> <br> <br>
              ...
              <%}%>
               <%if(cuentas!=null) {%>
               <form action="/Banco_proyectoI/Presentacion/Cajero/Deposito/add" method="POST">
               ...
               <p>Descripcion:</p><input  type="text" name="txtDescripcion" placeholder="Descripcion deposito">
               </div>
                   <h2>Cuenta a depositar</h2>
               <table>
            <thead>
