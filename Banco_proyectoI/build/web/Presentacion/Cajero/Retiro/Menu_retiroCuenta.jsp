...
<html>
  ...
  <%@ include file="/Presentacion/link.jsp" %>
    ...
    <body>
        ...
        <% if (cuenta==null){%>
        <form class="form_inicio" action="/Banco_proyectoI/Presentacion/Cajero/Retiro/showcuenta" method="POST">
        ...
        <%}%>
         <%if(cuenta!=null){%>
           <form class="form_inicio" action="/Banco_proyectoI/Presentacion/Cajero/Retiro/Add" method="POST">
              <h2>Retiro</h2> 
               ...
               <p>Monto:</p><input  type="text" class="<%=this.Invalida("txtMonto", errores) %>" name="txtMonto" placeholder="<%=this.placeholder("txtMonto", errores, "Monto") %>" > <br> <br>
