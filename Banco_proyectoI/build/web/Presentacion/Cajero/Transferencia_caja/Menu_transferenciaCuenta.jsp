...
<html>
  ...
  <%@ include file="/Presentacion/link.jsp" %>
    ...
    <body>
        ...
        <% if (cuenta==null){%>
        <form class="form_inicio" action="/Banco_proyectoI/Presentacion/Cajero/Transferencia/showcuenta" method="POST">
          
            <h2>Transferencia</h2>  
            <p>Numero cuenta:</p><input class="<%=this.Invalida("txtNumero", errores) %>" type="text" name="txtNumero" placeholder="<%=this.placeholder("txtNumero", errores, "Numero") %>"> <br> <br>
